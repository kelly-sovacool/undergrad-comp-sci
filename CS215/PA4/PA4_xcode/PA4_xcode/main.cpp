...
int main() {
    ...
    while (open_failed and numtries < 4)
    {
    ...
    if (!open_failed) { // get shapes until end of file reached
        while (!infile.eof())
        {
            string name;
            cin >> name;
    ...
    else // if 3 unsuccessful open attempts
        cout << "Maximum number of attempts reached. Bye!" << endl;
